...
# $FreeBSD: releng/11.0/sys/boot/powerpc/boot1.chrp/generate-hfs.sh 305904 2016-09-17 19:38:56Z jhibbits $
...
echo '# $FreeBSD: releng/11.0/sys/boot/powerpc/boot1.chrp/generate-hfs.sh 305904 2016-09-17 19:38:56Z jhibbits $' >> Makefile.hfs
...
echo '$FreeBSD: releng/11.0/sys/boot/powerpc/boot1.chrp/generate-hfs.sh 305904 2016-09-17 19:38:56Z jhibbits $' >> $OUTPUT_FILE.bz2.uu
